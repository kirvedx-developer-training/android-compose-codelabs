...
class PlantDetailFragmentTest {
    ...
    val composeTestRule = createAndroidComposeRule<GardenActivity>() // Testing compose in Android
    ...
    @Test
    fun testPlantName() {
        // We migrated this part of the UI to compose
        // onView(ViewMatchers.withText("Apple"))
        //    .check(ViewAssertions.matches(ViewMatchers.isDisplayed()))
        //
        // So we need to use compose assertions instead:
