...
private fun AlertCard() {
    ...
    // The old animation manually restarted the animation over and over, this is bad
    // for tests as it does not let the app go idle for tests to work - requiring us
    // to disable the animation for tests... this does work, however;
    //Card(elevation = animatedElevation.value) {

    // We can use Infinite animations - which were designed with this concept (synchronization) in
    // mind, which tests know how to work with!
